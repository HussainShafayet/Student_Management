...
<html>              
    <head>
        ...
        <title>Update CSE Student</title>
        <style>
            body{
    ...
    <body background="admin.jpg">
         <h1 style="text-align:center;color: coral">CSE Student Update Form</h1>
        <form name="form" method="post" class="reg" action="update_cseInfo.jsp">
        <%
        try{
        ...
        <div style="text-align:center">
            ...
            <a href="cse_stuInfo.jsp" class="btn btn-light">Back</a>
        </div>
        </form>
    </body>
