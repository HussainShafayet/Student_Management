...
<html>              
    ...
    <body background="admin.jpg">
         <h1 style="text-align:center;color: coral">CE Student Update Form</h1>
        <form name="form" method="post" class="reg" action="ce_update_process.jsp">
        <%
        try{
        ...
        <div style="text-align:center">
            ...
            <a href="ce_stuInfo.jsp" class="btn btn-light">Back</a>
        </div>
        </form>
    </body>
