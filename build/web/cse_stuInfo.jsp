...
<html>
    ...
    <body>
        <h1 style="text-align:center; color:lightseagreen">Information of CSE student</h1>
            ...
            <%
                String search=request.getParameter("search");
                 ...
                 ResultSet rs=null;
                    ...
                    if(search==null){
                        rs=st.executeQuery("select *from registration where dept='cse' order by sess ASC,reg_no ASC ");
                    }
                    if(search!=null && search.length()>0){
                        rs=st.executeQuery("select *from registration where dept='cse' and (reg_no like'"+search+"' or sess like'"+search+"' ) order by sess ASC,reg_no ASC");
                    }
                    else{
                        rs=st.executeQuery("select *from registration where dept='cse' order by sess ASC,reg_no ASC");
                    }
                    ...
                    while(rs.next()){
                       ...
                       <tr>
                           ...
                           <td><%=rs.getString("moname")%></td>
                            ...
                            <td><a href ="edit_cse.jsp?rsId=<%=rs.getString("id")%>" class="btn btn-warning">Edit</a></td>
